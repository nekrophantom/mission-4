    ...
    taskCard.innerHTML = `
      <div class="card-body p-3">
        <div class="flex justify-between items-center text-sm">
          <input type="checkbox" class="checkbox checkbox-primary mr-5" onclick="toggleStatusTask(${todo.id})" ${todo.completed ? "checked" : ""}>
          ...
          ${ isOverdue ? `<span class="badge badge-error text-xs px-2 py-1 mr-5 text-white">Overdue</span>` : "" }
          <span class="badge ${getPriorityBadge(todo.priorityLevel)} text-xs px-2 py-1 mr-5 text-white">${todo.priorityLevel}</span>
